...
(function() {
	...
	function init() {
		...
		leftSide.querySelector( 'div.side .intro-content h1' ).addEventListener( eventtype, function( ev ) {
			reset();
			classie.add( splitlayout, 'open-left' );
		} );

		rightSide.querySelector( 'div.side .intro-content h1' ).addEventListener( eventtype, function( ev ) {
			reset();
