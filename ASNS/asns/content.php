						...
						<div class="intro-content">
							<div class="profile"><img src="<?php $get_left_picture = esc_attr( get_option('left_user_pic') ); print $get_left_picture; ?>" alt="profile1"></div>
								...
								<span class="3rd" ><?php $leftDescription = esc_attr( get_option('left_user_description' ) ); print $leftDescription; ?></span>
									...
									<ul class="social-connect sc-left">
										
									<li><a href="http://www.facebook.com/<?php $leftFacebook = esc_attr( get_option('left_facebook_handler' ) ); print $leftFacebook; ?>" class="fb" title="facebook"></a></li>
									<li><a href="http://twitter.com/<?php $leftTwitter = esc_attr( get_option('left_twitter_handler' ) ); print $leftTwitter; ?>" class="tw" title="twitter"></a></li>
									<!--<li><a href="http://github.com/<?php $leftGithub = esc_attr( get_option('left_github_handler' ) ); print $leftGithub; ?>" class="gh" title="github"></a></li> -->
									<li><a href="#" class="mail ml" title="mail"></a></li>
									</ul>
						</div>
					...
					<?php if ( !empty( $right_video_src ) ) :
							...
							<h1><span class="1st" title="<?php _e( 'Nehal Salah', 'asns'); ?>"><?php	$rightFirstName = esc_attr( get_option('right_first_name' ) ); print $rightFirstName; ?>&nbsp;<span class="2nd" style="color:#626262;"><?php $rightLastName = esc_attr( get_option('right_last_name' ) ); print $rightLastName; ?></span></span> 
								<span><?php $rightDescription = esc_attr( get_option('right_user_description' ) ); print $rightDescription; ?></span>
									...
									<ul class="social-connect sc-right">
										
									<li><a href="http://www.facebook.com/<?php $rightFacebook = esc_attr( get_option('right_facebook_handler' ) ); print $rightFacebook; ?>" class="fb" title="facebook"></a></li>
									<li><a href="http://twitter.com/<?php $rightTwitter = esc_attr( get_option('right_twitter_handler' ) ); print $rightTwitter; ?>" class="tw" title="twitter"></a></li>
									<!--<li><a href="http://github.com/<?php $rightGithub = esc_attr( get_option('right_github_handler' ) ); print $rightGithub; ?>" class="gh" title="github"></a></li>-->
									<li><a href="#" class="mail mr" title="mail"></a></li>
